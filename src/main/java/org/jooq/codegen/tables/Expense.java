...
public class Expense extends TableImpl<ExpenseRecord> {
    ...
    public List<ForeignKey<ExpenseRecord, ?>> getReferences() {
        return Arrays.asList(Keys.EXPENSE__FK_EXPENSE_PK_ACCOUNT, Keys.EXPENSE__FK_EXPENSE_PK_BUCKET);
    }
    ...
    public BucketPath bucket() {
        if (_bucket == null)
            _bucket = new BucketPath(this, Keys.EXPENSE__FK_EXPENSE_PK_BUCKET, null);
