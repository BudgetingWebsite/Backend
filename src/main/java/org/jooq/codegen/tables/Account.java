...
public class Account extends TableImpl<AccountRecord> {
    ...
    /**
     * Get the implicit to-many join path to the <code>partition</code> table
     */
    public PartitionPath partition() {
        if (_partition == null)
            _partition = new PartitionPath(this, null, Keys.PARTITION__FK_PARTITION_PK_ACCOUNT.getInverseKey());
