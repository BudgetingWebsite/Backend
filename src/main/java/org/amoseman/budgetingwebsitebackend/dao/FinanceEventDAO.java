...
public abstract class FinanceEventDAO<C> extends DAO<C> {
     ...
     * @throws UserDoesNotExistException if the user does not exist.
     */
    public abstract List<FinanceEvent> getIncomeEvents(String user, LocalDateTime start, LocalDateTime end) throws UserDoesNotExistException;
     ...
     * @throws UserDoesNotExistException if the user does not exist.
     */
    public abstract List<FinanceEvent> getExpenseEvents(String user, LocalDateTime start, LocalDateTime end) throws UserDoesNotExistException;
