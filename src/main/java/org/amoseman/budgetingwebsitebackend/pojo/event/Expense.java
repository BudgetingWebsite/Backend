...
public class Expense extends FinanceRecord {
    ...
    public Expense(String uuid, LocalDateTime created, LocalDateTime updated, String owner, long amount, LocalDateTime occurred, String category, String description, String partition) throws NegativeValueException {
